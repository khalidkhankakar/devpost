...
const GlobalSearchResult = ({ debounceVal }: { debounceVal: string }) => {
  ...
  return (
    <div className="z-20 bg-gray-200  shadow-md   p-4 flex flex-col rounded-md w-[150%] md:w-full md:left-0 absolute top-12 -left-[60px]">
            ...
            {result.length > 0 ? (
              result.map((item: any, index: number) => (
                <Link
                  ...
                  className="flex w-full bg-gray-400 my-1 rounded-md cursor-pointer items-start gap-3 px-5 py-2.5 "
                >
                  <Image 
                    src="/icons/tags.svg"
                    alt="tags"
